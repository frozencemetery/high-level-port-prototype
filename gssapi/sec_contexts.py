...
class SecurityContext(rsec_contexts.SecurityContext):
    ...
    _complete: Optional[bool]
    
    def __new__(cls, base: Optional[rsec_contexts.SecurityContext] = None,
                token: Optional[bytes] = None, name: Optional[Name] = None,
                creds: Optional[Credentials] = None,
                lifetime: Optional[int] = None,
                flags: Optional[IntEnumFlagSet] = None,
                mech: Optional[Mechanism] = None,
                channel_bindings: Optional[ChannelBindings] = None,
                usage: Optional[str] = None) -> Any:
    ...
    def __init__(self, base: Optional[rsec_contexts.SecurityContext] = None,
                 token: Optional[bytes] = None, name: Optional[Name] = None,
                 creds: Optional[Credentials] = None,
                 lifetime: Optional[int] = None,
                 flags: Optional[IntEnumFlagSet] = None,
    ...
    def get_wrap_size_limit(self, desired_output_size: int,
    ...
    def _inquire(self, **kwargs: bool) -> tuples.InquireContextResult:
    ...
    @property
    def delegated_creds(self) -> Optional[Credentials]:
    ...
    # mypy can't handle decorated properties yet
    ...
    def _acceptor_step(self, token: bytes) -> Optional[bytes]:
    ...
    def _initiator_step(self,
                        token: Optional[bytes] = None) -> Optional[bytes]:
